...
public class NPC {
	...
	/**
	 * @return True if NPC is in the middle of a path.
	 */
	public boolean hasPath() {
		return hasPath;
	}
	
	protected void setPath(boolean b){
		hasPath = b;
	}
	...
	/**
	 * Change npc's pitch to new pitch
	 * 
	 * @param pitch New npc pitch
	 */
